function netSalaryCalc(income){
  // Constants for monthly tax rates and deductions
   const monthlyTaxablepay = [
      { minIncome: 0, maximumIncome: 24000, rate: 0.1 }, { minimumIncome: 24001, maximumIncome: 32333, rate: 0.25 },
      { minIncome: 32334, maximumIncome: 500000, rate: 0.30 }, { minimumIncome: 500001, maximumIncome: 800000, rate: 0.325 },
  ...
  // Confirm if the income falls within the current tax range
    if (income >= range.minimumIncome && income <= range.maximumIncome) {
  ...
  // Call the function with basic Salary and benefits
  const userInput = salaryAndBenefits(45500, 0);

  // Access the calculated values of the function
